...
void InitControls()
{
	...
	buttons[0] = new Button(new DigitalIn(PTC9));
	buttons[1] = new Button(new DigitalIn(PTC10));
	buttons[2] = new Button(new DigitalIn(PTC11));
	buttons[3] = new Button(new DigitalIn(PTC12));
}
